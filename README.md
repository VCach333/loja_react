...
1. In your command line run `git clone https://github.com/VCach33/loja_react`. It'll download the project to your Computer.
2. In your command line navigate to folder downloaded with command as `cd loja_react`.
3. After download success, run the command `npm install`. It'll download all package (dependecies) of Project. 